...
import { getBookLikes, getFavorites, getFavoritesCount, isFavorite, toggleFavorite } from '../controllers/favoritesController.js';

const router = express.Router();

router.get("/", verifyJWT, getFavorites);          // get all favorites
router.post("/toggle", verifyJWT, toggleFavorite);        // add/remove favorite
router.get("/all/count",getFavoritesCount);
